...
- A report that contains the introduction, methods, results, conclusions, and future directions.
...
## Methods
**Planned analyses**
- OLS regressions at the zipcode level estimating  
**Visualizations**
- Boxplot nutritional content by food category (n=?), and restaurant type (n=?) across combined years (2008-2020)
- Spaghetti plot nutritional content by restaurants
- Bar plots of top 15 NYC restaurant chains
- Maps stratified by resturant type, that illustrate restaurants with the most/least nutrient-dense menu items according to a national standard diet for the average adult (CDC MyPlate).
**coding challenges**
