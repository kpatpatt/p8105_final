...
```
## when i try to knit this document it isn't working, using the code `rmarkdown::render("Exploratory Anlalysis Flexdashboard.Rmd", output_format = "flexdashboard::flex_dashboard")` which i got from class website 
