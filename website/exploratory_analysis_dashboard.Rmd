...
```
## when i try to knit this document it isn't working, using the code `rmarkdown::render("exploratory_anlalysis_dashboard.Rmd", output_format = "flexdashboard::flex_dashboard")` which i got from class website 
